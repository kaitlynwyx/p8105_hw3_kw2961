...
The dataset includes 5 weeks/35 days of observations. The activity_* columns represent the data collected in each minute of the day. There are `r ncol(new) - 4` data being recorded each day. The week, day and day types of the data being collected are also shown in the table. 
...
The graph shows that the subject has the lowest level of activity during midnight to 6 am. This is probably due to lower physical activity during sleeping hours.  
